...
HD_PWD='X:/Studia/sem_m_2/KwPUS/KonwerterLiczb/KonwerterLiczb.runs/czarodziej_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log czarodziej.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source czarodziej.tcl
